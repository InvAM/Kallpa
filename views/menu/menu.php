    ...
    <body>
        <div class="contenedorP">
            <div class="contenedor1">
                ...
                <img src="../../Img/Kallpa.png" alt="Kallpa" class="Img1">
                <img src="../../Img/usuario (3).png" alt="Usuario" class="Img2" >
                ...
                <div class="datos">
                   ...
                   <div class="centro">
                    ...
                    <i class="mdi mdi-store-marker" style="width: 50px; height: 50px; font-size: 50px; color: white;"></i>
                    </div>
                    <div style="display: inline-block; vertical-align: middle;">
                    ...
                    <div style="display: inline-block; vertical-align: middle;">
                    <i class="mdi mdi-cellphone" style="width: 40px; height: 40px; font-size: 50px; color: white;"></i>
                    </div>
                    <div style="display: inline-block; vertical-align: middle;">
