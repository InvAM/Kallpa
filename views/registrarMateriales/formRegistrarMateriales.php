            ...
            <div class="contenedorS">
                <div class="cajaContrato">
                    ...
                    <div class="cajaContratoP">
                        ...
                        <input type="text" label="idContrato" id="IDContrato_M" name="IDContrato_M" placeholder="ID Contrato">
                        </div>
                        <div class="subcajita">
                        <label>Fecha Orden<label><br>
                        <input type="text" label="fecha" id="Fecha_O" name="Fecha_O" placeholder="Fecha de Orden">
                        </div>
                        <div class="subcajita">
                        <label>ID Etapa<label><br>
                        <input type="text" label="idEtapa" id="IDEtapa_M" name="IDEtapa_M"placeholder="ID Etapa">
                        </div>
                    </div> 
                </div>
            </div>
        ...
        <div class="ContenedorP1">
            <div class="CajaMaterial">
                ...
                foreach ($this->material as $opcion) { 
                    ...
                    $material =$opcion;  ?>
                      <option value="<?php echo $opcion->Nombre_Ma; ?>"><?php echo $opcion->Nombre_Ma; ?></option>
                <?php } ?>
                </select>
                <label>Cantidad<label>
                <input class="n1" type="number" name="Cantidad_Ma" id="Cantidad_Ma" label="cantidad" placeholder="Cantidad">
            ...
            <div class="CajaTabla">
                ...
                <form action="<?php echo constant('URL'); ?>registrarMateriales/registrarMateriales" class="formularioRM"name="formularioRM" id="formularioRM" method="POST">
                <div class="tabla">
