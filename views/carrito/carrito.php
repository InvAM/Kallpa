            ...
            <?php foreach ($_SESSION["carrito"] as $fila): ?>
                <div class="card">
                    <div class="card-body">
                        ...
                        <button href="#" class="btn btn-secondary">Borrar</button>
                    </div>
                </div>
                <div>
                    <button><a href="pagarProducto">Pagar</a></button>
                </div>
            <?php endforeach; ?>
            <button class="btn btn-primary"><a href="catalogo">Ver Catálogo</a></button>
        <?php endif; ?>
    </div>
