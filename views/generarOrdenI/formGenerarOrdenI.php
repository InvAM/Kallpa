        ...
        <div class="contenedorP">
            ...
            <div class="contenedor1">
                ...
                <div class="contenedorS">
                    ...
                    <div class="cajaOrdenI">
                        <form action="<?php echo constant('URL'); ?>generarOrdenI/registrarOrden" name="formularioGOI1"
                            id="formularioGOI1" method="POST">
                            <div class="subcajita">
                                <label class="Sub">Número de Orden</label><br>
                                <input type="text" label="numOrden" id="numOrden_G" name="numOrden_G"
                                    placeholder="Número de Orden" readonly>
                            </div>
                            <div class="subcajita">
            ...
            <div class="contenedorP2">
                <div class="contenedorS2">
                    <div class="CajaCalendario">
                        ...
                        <div class="calendario-wrapper">
                            <input class="calendario" type="date" id="selectedDate" name="selectedDate" min="2000-01-01"
                                max="2023-12-31" onchange="handleDateSelection(event)" required>
                        </div>
                    </div>
                    <br>
                    <div class="CajaTecnico">
                        <p class="TI2">Datos del técnico</p>
                        <form action="<?php echo constant('URL'); ?>generarOrdenI/registrarOrden" class="formularioGOI2"
                            name="formularioGOI2" id="formularioGOI2" method="POST">
                            ...
                            <input class="I2" type="text" id="NombreCompleto_Em" name="NombreCompleto_Em"
                                placeholder="Técnico" value="" readonly required>
                            <label class="Sub" for="DNI_Em_T">Dni del Técnico</label><br>
                            <input class="I2" type="text" id="DNI_Em_T" name="DNI_Em_T" placeholder="DNI" value=""
                                readonly required>
                        </form>
                ...
                <div class="contenedorS3">
                    ...
                    <form action="<?php echo constant('URL'); ?>generarOrdenI/registrarOrden" class="formularioGOI"
                        name="formularioGOI" id="formularioGOI" method="POST">
