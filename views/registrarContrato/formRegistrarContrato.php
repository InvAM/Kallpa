...
<body>
    <div class="registrar-contrato">
        ...
        <div class="cont-2">
            ...
            <div class="cont-cliente">
                ...
                <div class="grupo1">
                    ...
                    <input type="text" placeholder="DNI" name="dniCliente" id="dniCliente">
                </div>
                <div class="grupo2">
                    ...
                    <input type="text" label="" placeholder="Dirección Domicilio" name="direcDomicilio"
                        id="direcDomicilio" readonly>
                    <label for="">ID Domicilio</label>
                    <input type="text" label="" placeholder="ID Domicilio" name="iddomicilio" id="iddomicilio" readonly>
                </div>
                <form method="POST" action="<?php echo constant('URL'); ?>registrarContrato/buscarCliente"
                    class="formularioRC" name="formularioRC" id="formularioRC">
                    <div class="boton-cli">
                ...
                <div class="grupo2-cont">
                    ...
                    <div class="calendario-wrapper">
                        <input class="calendario" type="date" id="selectedDate" name="selectedDate" min="2000-01-01"
                            max="2023-12-31" onchange="handleDateSelection(event)">
                    </div>
                </div>
        ...
        <div class="cont-4">
            <div class="linea">
                ...
                <div class="espacio">
                    ...
                    <hr>
                    <div>
                        <h4>DNI : <span id="mostrarDNI" name="mostrarDNI"></span> </h4>
        ...
        <div class="cont-5">
            <div class="grupo1-boton">
                <form method="POST" action="<?php echo constant('URL'); ?>registrarContrato/registrarContrato"
                    class="formularioRC1" name="formularioRC1" id="formularioRC1">
    ...
    <script src="<?php echo constant('URL'); ?>public/js/contrato.js"></script>
</body>
