...
<head>
    ...
    <link rel="stylesheet" href="../../estilos/ConsultarClienteStyle/formConsultarCliente.css">
        ...
        <input type="text" id="buscador" placeholder="Buscar contrato por ID">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>87654321</td>
                        <td>
                        <button class="action-button select-button" @click="seleccionarContrato(item)">Selecionar</button>
